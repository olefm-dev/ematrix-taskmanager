...
[![Python Tests](https://github.com/olefm-dev/ematrix-taskmanager/actions/workflows/python-tests.yml/badge.svg)](https://github.com/olefm-dev/ematrix-taskmanager/actions/workflows/python-tests.yml)
